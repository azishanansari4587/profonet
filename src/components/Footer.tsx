...
const locations = [
  {
    ...
    address: 'Al Taha Residency 9th A Main Rd, opp. Iyengar Bakery, KEB Colony, New Gurappana Palya, BTM 1st Stage, Bengaluru, Karnataka 560029 IN',
  },
]
...
const Footer = () => {
  return (
    <footer className="py-3 w-full">
      <div className="rounded-lg bg-bgColor ">
        ...
        <hr />
        <section className="relative overflow-hidden bg-bgColor py-8">
